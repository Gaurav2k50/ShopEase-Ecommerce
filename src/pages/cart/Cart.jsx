...
function Cart() {
  // Accessing context for mode (dark or light mode)
  ...
  // State for total amount of items in cart
  ...
  // State variables for user details in modal
  ...
  const buyNow = async () => {
    ...
    // Payment options for Razorpay integration
    var options = {
      key: "rzp_test_d0QRZLNocoihLp",
      key_secret: "GQaAm8cPEL0JLmNgiobtQqPt",
      ...
      handler: function (response) {
        ...
        try {
          // Adding order information to Firestore
